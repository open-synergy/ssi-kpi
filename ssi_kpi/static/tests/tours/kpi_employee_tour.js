...
odoo.define("ssi_kpi.kpi_employee_tour", function (require) {
    "use strict";

    var tour = require("web_tour.tour");

    // Shared Flow 1 — Open the Human Resource > KPI > Employees menu.
    // "KPI Employees" is not a substring of the app's landing action
    ...
    function openMenuSteps() {
        return [
            ...
            {
                content: "Open the Employees menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_kpi.kpi_employee_menu"]',
            },
            {
                content: "KPI Employees list is displayed",
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(KPI Employees)",
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            ...
            // Flow 3 — Fill in the required fields
            {
                ...
                run: "text TOUR KPI EMP Create",
            },
            {
                content: "Pick the Employee",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(TOUR KPI EMP Create)",
                in_modal: false,
            },
            {
            ...
            },
            {
                ...
                run: "text TOUR KPI Employee Template",
            },
            {
                content: "Pick the Template",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(TOUR KPI Employee Template)",
                in_modal: false,
            },
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_edit",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Find and open the record to edit
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR KPI EMP Edit) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_delete",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to delete
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR KPI EMP Delete) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
            ...
            {
                content: "Back to the KPI Employees list",
                trigger: ".breadcrumb-item.o_back_button a:contains(KPI Employees)",
            },
            ...
            // Post-Condition — The record is permanently removed
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR KPI EMP Delete)))",
                run: function () {
                    // Assertion only.
                },
            },
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to confirm
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR KPI EMP Confirm) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to approve
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR KPI EMP Approve) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_reject",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to reject
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR KPI EMP Reject) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_finish",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to finish
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR KPI EMP Finish) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_cancel",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to cancel
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR KPI EMP Cancel) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_terminate",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to terminate
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR KPI EMP Terminate) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to restart
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR KPI EMP Restart) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
    ...
    // ─────────────────────────────────────────────────────────────
    tour.register(
        "ssi_kpi_kpi_employee_compute_realization",
        {test: true, url: "/web"},
        [].concat(openMenuSteps(), [
            // Flow 2 — Open the record to recompute
            {
                content: "Open the record",
                trigger:
                    ".o_data_row:contains(TOUR KPI EMP Compute) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                trigger: ".o_form_view",
