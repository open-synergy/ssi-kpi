        ...
        [].concat(
            ...
            [
                // Flow 2 — Open the record to delete
                {
                    content: "Open the record",
                    trigger:
                        ".o_data_row:contains(TOUR KPI EMP Delete) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    trigger: ".o_form_view",
        ...
        [].concat(
            ...
            [
                // Flow 2 — Open the record to reject
                {
                    content: "Open the record",
                    trigger:
                        ".o_data_row:contains(TOUR KPI EMP Reject) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    trigger: ".o_form_view",
        ...
        [].concat(
            ...
            [
                // Flow 2 — Open the record to finish
                {
                    content: "Open the record",
                    trigger:
                        ".o_data_row:contains(TOUR KPI EMP Finish) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    trigger: ".o_form_view",
        ...
        [].concat(
            ...
            [
                // Flow 2 — Open the record to cancel
                {
                    content: "Open the record",
                    trigger:
                        ".o_data_row:contains(TOUR KPI EMP Cancel) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    trigger: ".o_form_view",
