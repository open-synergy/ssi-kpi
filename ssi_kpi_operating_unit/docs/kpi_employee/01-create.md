...
- The Employees list is now filtered by operating unit (record rule). A user in
  the _Operating Unit_ data ownership group only sees records of operating units
  they are assigned to. This is not a Flow step.
